...
public class LeaderboardServerBridge : MonoBehaviour
{
    ...
    public int leaderboardID => SceneManager.GetActiveScene().buildIndex + 84;
    public string leaderboardSecret => secrets[SceneManager.GetActiveScene().buildIndex];
